...
const displaySum = acc => {
  ...
  labelSumIn.textContent = `${formatCurr(incom,acc.locale,acc.currency)}`;
...
btnLogin.addEventListener('click', e => {
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    //formating date according internationalization
